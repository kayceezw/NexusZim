      ...
      <div className="container-page">
        ...
        <div className="border-b border-gold/20 pb-12">
          ...
          <p className="mt-6 max-w-2xl font-body text-lg font-light text-foreground/70">
            The authoritative data layer for Zimbabwe's event industry. Access real-time radar,
            venue boards, and market rate indices.
          </p>
        </div>
...
function IntelCard({
  ...
  return (
    <Link
      to={to}
      className="group border border-gold/10 bg-card p-8 transition-all hover:border-gold/30 hover:bg-card/80"
    >
      <p className="font-mono text-[10px] text-gold uppercase tracking-widest">{stat}</p>
      <h3 className="mt-4 font-display text-2xl font-bold text-foreground group-hover:text-gold">
        {title}
      </h3>

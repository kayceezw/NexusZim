...
const SEED_EVENTS: EventRow[] = [
  {
    ...
    ticket_price_range: "$5 – $30",
    source: null,
    status: "booking_open",
  },
  {
    id: "s2",
    title: "Zim Hip Hop Awards",
    date: "2026-08-08",
    venue: "HICC Rainbow Towers",
    city: "Harare",
    genre: "Music & Awards",
    estimated_attendance: "2,000+",
    ticket_price_range: "$20 – $80",
    source: null,
    status: "booking_open",
  },
  {
  ...
  {
    id: "s4",
    title: "Vic Falls Carnival 2026",
    date: "2026-12-29",
    venue: "Victoria Falls Private Game Reserve",
    city: "Victoria Falls",
    genre: "Music Festival",
    estimated_attendance: "5,000+",
    ticket_price_range: "$50 – $250",
    source: null,
    status: "booking_open",
  },
  {
    id: "s5",
    title: "Harare Corporate Gala Season",
    date: "2026-07-01",
    venue: "Multiple CBD Venues",
    city: "Harare",
    genre: "Corporate",
    estimated_attendance: "Varies",
    ticket_price_range: "Invite Only",
    source: null,
    status: "upcoming",
  },
  {
    id: "s6",
    title: "ZimFest Live UK",
    date: "2026-08-01",
    venue: "Malvern Showground",
    city: "United Kingdom",
    genre: "Cultural Diaspora",
    estimated_attendance: "4,000+",
    ticket_price_range: "£25 – £85",
    source: null,
    status: "booking_open",
  },
  {
    ...
    date: "2026-09-10",
    venue: "Christmas Pass Hotel",
    city: "Mutare",
    genre: "Trade & Business",
  ...
  {
    id: "s8",
    title: "AfricaFest Harare",
    date: "2026-10-17",
    venue: "Harare Gardens",
    city: "Harare",
    genre: "Pan-African Culture",
    estimated_attendance: "12,000+",
    ticket_price_range: "$15 – $60",
    source: null,
    status: "upcoming",
  },
];
      ...
      <div className="grid gap-px bg-gold/10 lg:grid-cols-2">
        ...
        {events.map((event) => {
          ...
          return (
            <div
              key={event.id}
              className="bg-background p-8 border border-transparent hover:border-gold/20 transition-all"
            >

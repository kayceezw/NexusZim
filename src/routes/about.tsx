      ...
      <section className="border-b border-gold/10">
        <div className="container-page py-20 md:py-32">
          ...
          <p className="mt-10 max-w-2xl font-body text-xl font-light leading-relaxed text-foreground/70">
            NexusZim is the authoritative hub where event organizers, corporates, and individuals
            connect with verified service providers, book complete event packages, and access market
            intel no one else has.
          </p>
        </div>
      </section>
      ...
      <section className="container-page grid gap-px bg-gold/10 border border-gold/10 my-24 md:grid-cols-2">
        {VALUES.map((v) => (
          ...
          >
            ...
            <p className="mt-6 font-body text-base font-light leading-relaxed text-foreground/60">
              {v.desc}
            </p>
          </div>
        ))}

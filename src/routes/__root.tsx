...
import { SiteFooter, SiteHeader, WhatsAppSupport } from "@/components/site-chrome";
  ...
  head: () => ({
    meta: [
      ...
      { title: "NexusZim - Zimbabwe's marketplace for trusted services" },
      {
        name: "description",
        content:
          "Find, request and book vetted service providers in Zimbabwe across events, visa & business docs, transport, personal services, and more.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400;1,600&family=Archivo:wght@400;500;600;700&family=Spline+Sans+Mono:wght@400;500&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,

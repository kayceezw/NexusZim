    ...
    <div className="bg-cream pt-16">
      ...
      <div className="border-b border-hairline bg-cream-raised">
        <div className="container-page py-6">
          ...
          {category && <span className="font-mono text-[11px] text-text-soft/50 mx-2">/</span>}
          {category && (
            <Link
              to="/categories/$slug"
          ...
          <main className="lg:col-span-8 space-y-8">
            ...
            <section className="bg-cream-raised border border-hairline rounded-[6px] p-7">
              ...
              <div className="space-y-4">
                {reviews.map((r) => (
                  <blockquote key={r.id} className="border-l-[3px] border-gold pl-5 py-1">
          ...
          <aside className="lg:col-span-4 space-y-5 lg:sticky lg:top-24 lg:self-start">
            ...
            <div className="bg-forest-ink rounded-[6px] overflow-hidden">
              <div className="px-6 py-5 border-b border-cream/10">
                ...
                <div className="mt-3">
                  <Hallmark tier={provider.tier} className="!border-cream/30 !text-cream/70" />
                </div>
              </div>
            ...
            <div className="bg-cream-raised border border-hairline rounded-[6px] p-6">
              <div className="mb-4">
                ...
                <p className="font-display text-4xl text-text mt-1">
                  ${provider.priceFrom}
                  <span className="font-sans text-base font-normal text-text-soft ml-1">
                    / project
                  </span>
                </p>
              </div>
          ...
          <div className="container-page">
            ...
            <div className="space-y-3">
              {similarProviders.map((p) => (
                <div
                  key={p.id}
                  className="group bg-cream-raised border border-hairline rounded-[6px] hover:border-forest transition-all duration-150 relative overflow-hidden"
                >
                  ...
                  <div className="flex gap-0 min-h-[80px]">
                    <div
                      className={`flex-shrink-0 w-[64px] flex items-center justify-center font-sans text-base font-bold border-r border-hairline ${p.avatarColor}`}
                    >
                      {p.initials}
                    </div>
